...
class SOP(models.Model):
    ...
    reviewed_by = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL, related_name="sop_reviews")
    published_by = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL, related_name="sop_publishers")
    ...
    media_file = models.FileField(
        upload_to="sops/", null=True, blank=True,
